...
def main():
    st.title('Regal Project Classifier')
    ...
    st.markdown("Regal photo for classification.")
...
def load_model():
    ...
    if plt == 'Linux' or plt == 'Darwin': pathlib.WindowsPath = pathlib.PosixPath
    inf_model = load_learner('Regal_Project_1.pkl', cpu=True)
...
EXTERNAL_DEPENDENCIES = {
    "Regal_Project_1.pkl": {
        "url": "https://www.dropbox.com/s/xin8h6tl5ufh8p5/Regal_Project_1.pkl?dl=1",
        "size": 179197952
    }
}
